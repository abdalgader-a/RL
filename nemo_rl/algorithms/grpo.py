...
def grpo_train(
    ...
    while current_epoch < max_num_epochs and current_step < max_num_steps:
        ...
        for batch in dataloader:
            ...
            maybe_gpu_profile_step(policy, current_step + 1)
            if policy != policy_generation:
                maybe_gpu_profile_step(policy_generation, current_step + 1)
            ...
            with timer.time("total_step_time"):
                ...
                # TODO(ahmadki): cleanup
                # is_last_step = current_step + 1 == min(max_num_steps, len(dataloader))
